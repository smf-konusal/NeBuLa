...
function template_settings()
{
	...
	$context['theme_settings'] = array(
		...
		array(
			'id' => 'snrjfooter',
			'label' => $txt['snrjfooter'],
		),	
		array(
			'id' => 'snrjhakkindabaslik',
			'label' => $txt['snrjhakkindabaslik'],
			'type' => 'text',
		),
		array(
			'id' => 'snrjhakkindaicerik',
			'label' => $txt['snrjhakkindaicerik'],
			'type' => 'text',
		),
	'',
		array(
			'id' => 'snrjlinkbaslik',
			'label' => $txt['snrjlinkbaslik'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlibaslik',
			'label' => $txt['snrjhizlibaslik'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlilink',
			'label' => $txt['snrjhizlilink'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlibaslik1',
			'label' => $txt['snrjhizlibaslik1'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlilink1',
			'label' => $txt['snrjhizlilink1'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlibaslik2',
			'label' => $txt['snrjhizlibaslik2'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlilink2',
			'label' => $txt['snrjhizlilink2'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlibaslik3',
			'label' => $txt['snrjhizlibaslik3'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlilink3',
			'label' => $txt['snrjhizlilink3'],
			'type' => 'text',
		),
	'',
		array(
			'id' => 'snrjlinkbaslik1',
			'label' => $txt['snrjlinkbaslik1'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlibaslik4',
			'label' => $txt['snrjhizlibaslik4'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlilink4',
			'label' => $txt['snrjhizlilink4'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlibaslik5',
			'label' => $txt['snrjhizlibaslik5'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlilink5',
			'label' => $txt['snrjhizlilink5'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlibaslik6',
			'label' => $txt['snrjhizlibaslik6'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlilink6',
			'label' => $txt['snrjhizlilink6'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlibaslik7',
			'label' => $txt['snrjhizlibaslik7'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjhizlilink7',
			'label' => $txt['snrjhizlilink7'],
			'type' => 'text',
		),
	'',
		array(
			'id' => 'snrjbilgibaslik',
			'label' => $txt['snrjbilgibaslik'],
			'type' => 'text',
		),	
		array(
			'id' => 'snrjbilgiicerik',
			'label' => $txt['snrjbilgiicerik'],
			'type' => 'text',
		),	
