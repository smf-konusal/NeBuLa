...
function template_body_above()
{
    ...
    <header id="sideheader">
      <div class="mui-appbar mui--appbar-line-height">
		...
		echo '		<li><a href="', $scripturl, '?action=unread" title="', $txt['unread_since_visit'], '"><span class="main_icons posts"></span> ', $txt['view_unread_category'], '</a></li>
					<li><a href="', $scripturl, '?action=unreadreplies" title="', $txt['show_unread_replies'], '"><span class="main_icons drafts"></span> ', $txt['unread_replies'], '</a></li>';
		echo '		<li><a href="', $scripturl, '?action=recent"><span class="main_icons recent_posts"></span> ', $txt['recent_posts'], '</a></li>
					<li><a href="', $scripturl, '?action=stats" title="', $txt['more_stats'], '"><span class="main_icons stats"></span> ', $txt['forum_stats'], '</a></li>
					<li><a href="', $scripturl, '?action=recent"><span class="main_icons im_on"></span> ', $txt['recent_view'], '</a></li>
					<li><a href="' . $scripturl . '?action=who"><span class="main_icons people"></span> '. $txt['online_users']. '</a></li>
				  </ul>
			</div>
			<a class="mobile_user_menu">☰</a>
				<div id="main_menu">
